...
class BasicServiceClientTest {
  ...
  public:
  BasicServiceClientTest(std::string client_node_name, std::string service_name, 
                        std::chrono::duration service_timeout)
  {
  ...
  bool send_request(std::shared_ptr<ServiceT::Request> request, std::shared_ptr<ServiceT::Result> result) 
  {
  ...
  std::chrono::duration service_timeout_;
